...
Mod2 which is the our fitted model in the first part of the problem has the lowest rmse. Thus our model `bwt ~ babysex + bhead + blength + delwt + fincome + gaweeks + mheight + mrace + parity + ppwt + smoken`has a best fit amoung those three models.
